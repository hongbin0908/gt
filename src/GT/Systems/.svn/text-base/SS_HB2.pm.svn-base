...
sub long_signal {
	...
	if ( (is_long_signal($sma1_value, $sma2_value, $sma3_value) == 1 )
		 && (is_long_signal($sma1_value_b, $sma2_value_b, $sma3_value_b) == 0)) {
			 return 1;
		 }
	return 0;
}
